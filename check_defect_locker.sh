...
#Send files to the other PC

scp $fileName $defectFile noc@172.29.7.9:/home/noc/ansible/noc_defect/data

#Delete files older than 14 days

find ./data -maxdepth 1 -type f \( -name "locker_*.txt" -o -name "defect_*.csv" \) -mtime +13 -print -delete
